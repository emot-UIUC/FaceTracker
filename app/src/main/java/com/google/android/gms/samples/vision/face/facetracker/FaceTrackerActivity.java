...
public final class FaceTrackerActivity extends AppCompatActivity {
    ...
    private void startService(Class<?> service, ServiceConnection serviceConnection, Bundle extras) {
        ...
        Toast.makeText(getApplicationContext(), "USB Starting!", Toast.LENGTH_SHORT).show();
    ...
    private static class MyHandler extends Handler {
        ...
        public MyHandler(FaceTrackerActivity activity) {
            mActivity = new WeakReference<FaceTrackerActivity>(activity);
        }
    ...
    private class GraphicFaceTracker extends Tracker<Face> {
        ...
        public void onUpdate(FaceDetector.Detections<Face> detectionResults, Face face) {
            ...
            float smileprob = mFaceGraphic.getSmilingProbability();
